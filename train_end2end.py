...
from rcnn.symbol.symbol_resnet_rfcn import *
...
def train_net(args, ctx, pretrained, epoch, prefix, begin_epoch, end_epoch,
    ...
    if args.resume:
        ...
        arg_params['rfcn_bbox_weight'] = mx.random.normal(0, 0.001, shape=arg_shape_dict['rfcn_bbox_weight'])
...
def parse_args():
    ...
    # e2e
    parser.add_argument('--gpus', help='GPU device to train with', default='0,1,2', type=str)
